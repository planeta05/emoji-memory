...
var htmlEntityCodeRange = [128512, 129488];
var emojiArray = [];
var fieldContainer = document.querySelector(".field");
fillEmojiArray();
var memoryArray = duplicateArrayElements(emojiArray);
var cardsChoosen = [];
var choosenCardIds = [];
memoryArray.sort(function () {
  return 0.5 - Math.random();
});
createBoard();
function fillEmojiArray() {
  for (var i = htmlEntityCodeRange[0]; i <= htmlEntityCodeRange[0] + 9; i++) {
    emojiArray.push("&#" + i + ";");
  }
}
function createBoard() {
  memoryArray.forEach(function (element, i) {
...
function checkMatch() {
  ...
  var _choosenCardIds = choosenCardIds,
    _choosenCardIds2 = _slicedToArray(_choosenCardIds, 2),
    firstId = _choosenCardIds2[0],
    secondId = _choosenCardIds2[1];
  var _cardsChoosen = cardsChoosen,
    _cardsChoosen2 = _slicedToArray(_cardsChoosen, 2),
    firstCardEmoji = _cardsChoosen2[0],
    secondCardEmoji = _cardsChoosen2[1];
  if (firstId === secondId) {
